...
def get_recent_alerts(technique_id=None, minutes=5):
    ...
    technique_queries = {
        ...
        "T1003.006": {"bool": {"must": [{"term": {"event.code": "4662"}}, {"bool": {"should": [{"wildcard": {"winlog.event_data.Properties": "*1131f6aa*"}}, {"wildcard": {"winlog.event_data.Properties": "*1131f6ad*"}}, {"wildcard": {"winlog.event_data.Properties": "*89e95b76*"}}]}}], "must_not": [{"term": {"winlog.event_data.SubjectUserSid": "S-1-5-18"}}, {"wildcard": {"winlog.event_data.SubjectUserName": "*$"}}]}},
        ...
        "T1110":     {"bool": {"must": [{"term": {"event.code": "4625"}}], "must_not": [{"term": {"winlog.event_data.TargetUserName": "ANONYMOUS LOGON"}}]}},
        "T1069":     {"bool": {"must": [{"term": {"event.code": "3"}}, {"term": {"winlog.event_data.DestinationPort": "389"}}]}},
        "T1550.002": {"bool": {"must": [{"term": {"event.code": "4624"}}, {"term": {"winlog.event_data.LogonType": "3"}}, {"term": {"winlog.event_data.AuthenticationPackageName": "NTLM"}}], "must_not": [{"wildcard": {"winlog.event_data.TargetUserName": "*$"}}, {"term": {"winlog.event_data.TargetUserName": "ANONYMOUS LOGON"}}, {"term": {"winlog.event_data.TargetUserName": ""}}]}},
        "T1021.002": {"bool": {"must": [{"term": {"event.code": "7045"}}, {"wildcard": {"winlog.event_data.ImagePath": "*%systemroot%*"}}]}},
        "T1562.001": {"bool": {"must": [{"term": {"event.code": "7036"}}, {"term": {"winlog.event_data.param1": "Microsoft Defender Antivirus Service"}}, {"term": {"winlog.event_data.param2": "stopped"}}]}},
