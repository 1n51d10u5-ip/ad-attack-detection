...
│                   AD Lab (VirtualBox)               │
│                                                     │
│  DC01 (192.168.56.10) ── Windows Server 2022        │
│  WS01 (192.168.56.11) ── Windows 10 Enterprise      │
│  WS02 (192.168.56.12) ── Windows 10 Enterprise      │
│  SIEM (192.168.56.20) ── Ubuntu 22.04 + Elastic     │
│                                                     │
│  Kali Linux (attacker) ── Mac M1 via UTM            │
└─────────────────────────────────────────────────────┘
```
